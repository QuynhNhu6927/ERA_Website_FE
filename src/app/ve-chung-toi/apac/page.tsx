...
export const metadata: Metadata = {
  ...
  description:
    "ERA Châu Á Thái Bình Dương - Mạng lưới bất động sản hàng đầu khu vực được dẫn dắt bởi trụ sở Singapore. Tiên phong kết nối các cơ hội đầu tư bất động sản xuyên quốc gia tại Châu Á.",
